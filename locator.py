...
locator_types = ["XPath", "CSS Selector", "ID", "Class", "Name", "Tag", "Link Text",
                 "Partial Link Text", "Aria-label", "Title", "Data-custom"]
...
tk.Button(frame_btns, text="🎯 Generate Locator Code", command=generate_code).grid(row=0, column=0, padx=10)
tk.Button(frame_btns, text="📋 Copy to Clipboard", command=copy_to_clipboard).grid(row=0, column=1, padx=10)
